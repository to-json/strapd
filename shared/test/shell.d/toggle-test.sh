...
flag="$test_home/.local/state/strapd/toggles/example"
bar_flag="$test_home/.local/state/strapd/toggles/bar-off"

HOME="$test_home" strapd-toggle example on
...
HOME="$test_home" strapd-toggle-bar off
