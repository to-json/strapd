...
class TranscodeAction(GObject.GObject, Nautilus.MenuProvider):
    def _launch_transcode(self, paths):
        wrapper = shutil.which("strapd-launch-floating-terminal-with-presentation")
        binary = shutil.which("strapd-transcode")
    ...
    def _make_item(self, paths):
        ...
        item = Nautilus.MenuItem(
            name="strapdTranscodeNautilus::transcode",
            label=label,
    ...
    def _tools_available(self):
        return bool(
            shutil.which("strapd-launch-floating-terminal-with-presentation")
            and shutil.which("strapd-transcode")
        )
