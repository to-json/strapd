...
run_logged "$STRAPD_INSTALL/config/increase-lockout-limit.sh"
run_logged "$STRAPD_INSTALL/config/fix-powerprofilesctl-shebang.sh"
...
run_logged "$STRAPD_INSTALL/config/snapper.sh"
run_logged "$STRAPD_INSTALL/config/locate.sh"
